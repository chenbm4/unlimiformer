...
def main():
    ...
    parser.add_argument("--input_file", type=str, required=True, help="File path to the JSON file with prompts")
    parser.add_argument("--output_file", type=str, required=True, help="The output file to save the generated sequences.")
    ...
    if os.path.exists(args.input_file):
        with xopen(args.input_file, 'r') as f:
            lines = f.readlines()
    else:
